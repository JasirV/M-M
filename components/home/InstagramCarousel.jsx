...
const InstagramCarousel = () => {
  const [posts, setPosts] = useState([
    ...
    // },
    {
      media_type:"IMAGE",
      media_url:'',
      caption:"https://digital.ihg.com/is/image/ihg/crowne-plaza-new-delhi-6332359191-4x3",
      permalink:"#"
    }
  ]);
      ...
      >
        {[...Array(16)].map((_, index) => (
          ...
          <div className="border rounded-lg overflow-hidden  bg-white text-center shadow-md relative group">
            {posts[0].media_type === "IMAGE" && (
              <div className="relative w-full h-96">
                <Image
                  src={"https://digital.ihg.com/is/image/ihg/crowne-plaza-new-delhi-6332359191-4x3"}
