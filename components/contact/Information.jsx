  ...
  return (
    <div className=" flex flex-col items-center justify-center p-8 ">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Head Office */}
        <div className="p-6 border border-black dark:border-white rounded-lg shadow-md flex flex-col items-center text-center">
          <FaMapMarkerAlt className="text-black dark:text-white text-4xl mb-4" />
        ...
        {/* Phone */}
        <div className="p-6 border border-black dark:border-white rounded-lg shadow-md flex flex-col items-center text-center">
          <FaPhoneAlt className="text-black dark:text-white text-4xl mb-4" />
        ...
        {/* Email */}
        <div className="p-6 border border-black dark:border-white rounded-lg shadow-md flex flex-col items-center text-center">
          <FaEnvelope className="text-black dark:text-white text-4xl mb-4" />
