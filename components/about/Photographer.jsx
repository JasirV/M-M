    ...
    <section className="py-12 bg-white">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">{photographerDetails.name}</h2>
          ...
          <button className="bg-black text-white px-6 py-2 rounded-full shadow-md hover:bg-white hover:text-black hover:border-black first-letter: hover:border transition">
